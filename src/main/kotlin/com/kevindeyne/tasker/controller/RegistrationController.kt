...
@RestController
class RegistrationController(val userRepository: UserRepository, val passwordEncoder: PasswordEncoder, val activationRepository: ActivationRepository) {
	...
	fun submitRegistration(@RequestBody form : RegistrationForm) : FormResponse {
		return RegistrationService(userRepository, passwordEncoder, activationRepository).registerUser(form)
	}
