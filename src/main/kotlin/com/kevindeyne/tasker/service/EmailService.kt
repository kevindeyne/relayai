...
@Component
open class EmailService(var userRepository: UserRepository, var projectRepository: ProjectRepository, var passwordEncoder : PasswordEncoder, val mailSender : MailSender, val environment: Environment) {
