	...
	fun sendActivationMail(key : String, email : String) {
		if(!environment.getActiveProfiles().contains("dev")){
			...
			helper.setText("<!doctype html>" +
					...
					"                                  <tbody>" +
					"                                    <tr>" +
					"                                      <td style=\"font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;\"> <a href=\"https://www.relayai.io/activate/$key\" target=\"_blank\" style=\"display: inline-block; color: #ffffff; background-color: #3498db; border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #3498db;\">Activate my account</a> </td>" +
					"                                    </tr>" +
					"                                  </tbody>" +
					"                                </table>" +
					"                              </td>" +
