...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record5<Long, String, String, Long, Integer> {

    private static final long serialVersionUID = 1399263297;
     ...
     */
    @Override
    public ProjectRecord values(Long value1, String value2, String value3, Long value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Long id, String title, String key, Long activeSprintId, Integer sprintLength) {
        super(Project.PROJECT);
